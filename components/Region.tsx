    ...
    <section id="regiao" className="py-24 bg-brand-sand relative">
      <div className="w-full max-w-[1920px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
          ...
          {/* Item 1 - Tall */}
          <div className="md:row-span-2 relative group overflow-hidden rounded-sm cursor-zoom-in reveal">
            <img 
              src="https://images.unsplash.com/photo-1582468536034-780c10b407d5?auto=format&fit=crop&q=80&w=800" 
              alt="Pico das Almas" 
              className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110"
            />
            <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors duration-500"></div>
            <div className="absolute bottom-0 left-0 p-8 w-full bg-gradient-to-t from-black/80 to-transparent opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <span className="text-brand-gold text-xs uppercase tracking-widest font-bold">Natureza</span>
                <h3 className="text-white font-serif text-2xl mt-1">Pico das Almas</h3>
            </div>
          </div>

          {/* Item 2 */}
          <div className="relative group overflow-hidden rounded-sm cursor-zoom-in reveal">
             <img 
              src="https://images.unsplash.com/photo-1518182170546-0766ce6fec93?auto=format&fit=crop&q=80&w=800" 
              alt="Cachoeira Véu da Noiva" 
              className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110"
            />
            <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors duration-500"></div>
             <div className="absolute bottom-0 left-0 p-6 w-full bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <h3 className="text-white font-serif text-xl">Véu da Noiva</h3>
            </div>
          </div>
          ...
          <div className="relative group overflow-hidden rounded-sm cursor-zoom-in reveal">
             <img 
              ...
              alt="Caminho do Fraga" 
              className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110"
            />
             <div className="absolute bottom-0 left-0 p-6 w-full bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <h3 className="text-white font-serif text-xl">Rio de Contas</h3>
            </div>
          </div>

          {/* Item 4 - Wide */}
          <div className="md:col-span-2 relative group overflow-hidden rounded-sm cursor-zoom-in reveal">
             <img 
              src="https://images.unsplash.com/photo-1495573797587-c81b94c30c88?auto=format&fit=crop&q=80&w=1200" 
              alt="Pôr do sol" 
              className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110"
            />
            <div className="absolute inset-0 bg-brand-green/10 mix-blend-overlay"></div>
             <div className="absolute bottom-0 left-0 p-8 w-full bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <span className="text-brand-gold text-xs uppercase tracking-widest font-bold">Experiência</span>
                <h3 className="text-white font-serif text-2xl mt-1">Entardecer na Serra</h3>
            </div>
          </div>
        </div>
